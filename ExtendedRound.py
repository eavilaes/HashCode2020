...
#for x in range (0, len(libraries)-1):
    #libraries[timeA[x].id].points+=(len(libraries)-x)
...
libraries.sort(key=lambda l: l.booksPerDay, reverse = False)

print ("id  points  books   signup  effic")
#for x in libraries:
    #x.points = x.pointsS/x.pointsE + x.pointsT
#    print (str(x.id) + ":   " + str(x.points) + "       " + str(len(x.books)) + "     " + str(x.signupTime) + "     " + str(x.booksPerDay))
